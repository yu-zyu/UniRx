...
{
    public class ToYieldInstructionSample : MonoBehaviour
    {
        private void Start()
        {
        ...
        private IEnumerator ReadFileCoroutine()
        {
            ...
            // 失敗時の例外を保持してくれるようになる(trueの場合は例外がそのままthrowされる）
            var yi = ReadFileAsync(@"data.txt").ToYieldInstruction(throwOnError: false);
